...
export async function sendReturnRequestEmail(
  ...
  try {
    ...
    // 주의사항 목록
    const warnings = [
      "상품 수령 후 7일 이내 신청, 14일 이내 상품 도착 시 환불이 가능합니다.",
      "상품이 훼손된 경우 환불이 불가합니다. (라벨제거/세탁/착용 등)",
      "고객 단순 변심 시 선불로 직접 발송하시거나, 결제 대금에서 왕복 배송비가 차감됩니다.",
      "상품 불량/오배송 시 반품 배송비는 무료입니다.",
    ];
